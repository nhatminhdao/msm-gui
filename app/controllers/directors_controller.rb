class DirectorsController < ApplicationController
  ...
  def destroy
    director_to_del_id = params.fetch("path_id")

    matching_records = Director.where({ :id => director_to_del_id})

    director_to_del = matching_records.first

    director_to_del.destroy
